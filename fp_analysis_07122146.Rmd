...
fp <- read.csv("/Users/suman/Documents/Suman/PSD-GHAN-GASD/GoN consultancies/Recent EoIs GoN/FP/Analysis/Test/fp.csv")
dim(fp)
fp<- as.data.frame(fp)
typeof(fp)
library(tidyverse)
...
table1 :: table1(~ province + respcastecode + q107 + agegroup + respedungrp +  q112 + quintile + ageatmarriagegroup + livingchildgrp + husbedungrp + q113 + q120a + spouseagediffgrp | typeoflocal1, caption = "Summary of Demographic Statistics", data = fp)
