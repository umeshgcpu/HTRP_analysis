...
typeof(fp$province)
levels(fp[,"province"])
fp$province = factor(fp$province, labels=c("one", "two", "bagmati", "gandaki", "lumbini", "karnali","susurpaschim"))
typeof(fp$province)
levels(fp[,"province"])
...
typeof(fp$district)
levels(fp[,"district"])
fp$district = factor(fp$district, labels=c("jhapa", "bara", "lalitpur", "syangja", "kapilvastu","pyuthan", "dailekh", "achham", "kailali"))
typeof(fp$district)
levels(fp[,"district"])
